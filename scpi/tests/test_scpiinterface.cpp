...
{
    cSCPI interface;
    std::shared_ptr<SCPITestObjectStub> obj = std::make_shared<SCPITestObjectStub>("foo", SCPI::isQuery);
...
{
    cSCPI interface;
    std::shared_ptr<SCPITestObjectStub> obj1 = std::make_shared<SCPITestObjectStub>("foo", SCPI::isQuery);
    interface.insertScpiCmd(QStringList() << "root1", obj1);
    std::shared_ptr<SCPITestObjectStub> obj2 = std::make_shared<SCPITestObjectStub>("bar", SCPI::isQuery);
...
void test_scpiinterface::addFindTwoIdenticalSecondOverwrites()
{
    ...
    std::shared_ptr<SCPITestObjectStub> obj1 = std::make_shared<SCPITestObjectStub>("foo", SCPI::isQuery);
    interface.insertScpiCmd(QStringList() << "root" << "child", obj1);
    std::shared_ptr<SCPITestObjectStub> obj2 = std::make_shared<SCPITestObjectStub>("foo", SCPI::isQuery);
    interface.insertScpiCmd(QStringList() << "root" << "child", obj2);
...
{
    cSCPI interface;
    std::shared_ptr<SCPITestObjectStub> obj1 = std::make_shared<SCPITestObjectStub>("xxxx", SCPI::isQuery);
    interface.insertScpiCmd(QStringList() << "root" << "child", obj1);
    std::shared_ptr<SCPITestObjectStub> obj2 = std::make_shared<SCPITestObjectStub>("XXXX", SCPI::isQuery);
    interface.insertScpiCmd(QStringList() << "ROOT" << "CHILD", obj2);
...
{
    cSCPI interface;
    std::shared_ptr<SCPITestObjectStub> obj1 = std::make_shared<SCPITestObjectStub>("xxxxxx", SCPI::isQuery);
...
{
    cSCPI interface;
    std::shared_ptr<SCPITestObjectStub> obj1 = std::make_shared<SCPITestObjectStub>("x", SCPI::isQuery);
